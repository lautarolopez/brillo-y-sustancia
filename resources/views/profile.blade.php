            ...
            <div class="tab-pane fade" id="list-direcciones" role="tabpanel" aria-labelledby="list-direcciones-list">
                <form action="/editar-direccion" method="POST" class="edit-profile">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="street" name="street" value="{{$user->name}}" required>
                            </div>
                        <div class="form-group">
                            <label for="address_number">Numero</label>
                            <input type="number" class="form-control" id="address_number" name="address_number" value="{{$user->last_name}}" required>
                        </div>
                        <div class="form-group">
                            <label for="floor">Piso</label>
                            <input type="number" class="form-control" id="floor" name="floor" value="{{$user->email}}" required>
                        </div>
                        <div class="form-group">
