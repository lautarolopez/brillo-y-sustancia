<nav class="admin-navbar">
    ...
    <ul>
        ...
        <a class="menu-element" href="{{route('users.index')}}"><li><i class="fas fa-users"></i>Usuarios</li></a>
        <a class="menu-element" href="{{route('categories.index')}}"><li><i class="fas fa-list-ol"></i>Categorías</li></a>
        <a class="menu-element" href="{{route('admin-products.index')}}"><li><i class="fas fa-dolly"></i>Productos</li></a>
        <a class="menu-element" href="{{route('sales.index')}}"><li><i class="fas fa-money-bill-wave"></i>Ventas</li></a>
